...
function MobileApp() {
  ...
  return <UITheme.Provider value={color}><SafeAreaView edges={['top','left','right']} style={[styles.screen,{backgroundColor:color.bg}]}>
    ...
    <View style={[styles.header,{backgroundColor:color.panel,borderColor:color.border}]}>
      <View style={styles.brand}><View style={styles.brandIcon} aria-hidden><View style={styles.brandMark}><View style={[styles.brandBar,{height:12}]}/><View style={[styles.brandBar,{height:27}]}/><View style={[styles.brandBar,{height:19}]}/><View style={styles.brandSightline}/></View></View><Text style={[styles.wordmark,textStyle]}>NyayaLens</Text></View>
    ...
    <ScrollView ref={scroll} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      {!session?<>
        <View style={styles.welcomeCard}><Text style={styles.welcomeEyebrow}>NYAYALENS / LABEL INTELLIGENCE</Text><Text style={styles.welcomeTitle}>A little clarity.</Text><Text style={styles.welcomeItalic}>On every label.</Text><Text style={styles.welcomeNote}>Demo workspace · Human review matters</Text></View>
...
const styles=StyleSheet.create({
  ...
  brand:{flexDirection:'row',gap:10,alignItems:'center'},brandIcon:{width:34,height:34,borderRadius:10,backgroundColor:'#17684e',alignItems:'center',justifyContent:'center'},brandMark:{width:26,height:28,flexDirection:'row',alignItems:'flex-end',gap:4},brandBar:{width:3,backgroundColor:'#fffdf8'},brandSightline:{position:'absolute',left:8,bottom:6,width:18,height:1,backgroundColor:'#61cfd8'},wordmark:{fontSize:24,fontWeight:'800',letterSpacing:-1.2},connectionDot:{fontSize:10},iconButton:{width:44,height:44,borderWidth:1,borderRadius:13,alignItems:'center',justifyContent:'center'},more:{fontSize:17,letterSpacing:2},
